...
export namespace identity {
    ...
    export class ServiceClient {
        ...
        public async createUser(params: CreateUserRequest): Promise<CreateUserResponse> {
            ...
            const resp = await this.baseClient.callTypedAPI("POST", `/identity/user/create`, JSON.stringify(params))
        ...
        public async getOrCreateUser(params: GetOrCreateUserRequest): Promise<GetOrCreateUserResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/identity/user/get-or-create`, JSON.stringify(params))
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "recipe-backend-5yt2-Generated-TS-Client (Encore/v1.52.3)";
        }
