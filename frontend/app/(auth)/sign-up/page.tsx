...
export default function SignUpPage() {
  ...
  // Zaten giriş yapılmışsa home'a yönlendir
  useEffect(() => {
    if (isSignedIn) {
      router.push("/home");
    }
  ...
  const signUpWithGoogle = async () => {
    ...
    try {
      // Mobil ise Vercel URL + source=native
      // Web ise kendi origin'ini kullan
    ...
    <div className="flex min-h-screen items-center justify-center bg-[#FAF9F7] p-6">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-xl py-3 px-4 hover:bg-gray-50 transition-colors"
        >
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            ...
            <a href="/sign-in" className="text-[#FF6B35] hover:text-[#e55a2b] font-medium">
              Giriş yapın
            </a>
          </p>
        </div>
